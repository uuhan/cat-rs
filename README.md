## cat [![Build Status](https://travis-ci.org/uuhan/cat-rs.svg?branch=master)](https://travis-ci.org/uuhan/cat-rs) [![crates.io](http://meritbadge.herokuapp.com/cat-rs)](https://crates.io/crates/cat-rs)
